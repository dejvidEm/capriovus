            ...
            >
              ...
              <div className="relative flex items-center z-20">
                ...
                <motion.img
                  ...
                  className="w-full max-w-xs lg:max-w-sm mx-auto lg:mx-0 object-contain relative z-10"
                ...
                <motion.img
                  src="/img1.png"
                  alt="Capriovus Products"
                  className="w-full max-w-xs lg:max-w-sm mx-auto lg:mx-0 object-contain relative -ml-12 lg:-ml-16"
